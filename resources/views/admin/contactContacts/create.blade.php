                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.contact-contacts.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('latitude') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="latitude" id="latitude" value="{{ old('latitude') }}" step="0.1">
                        ...
                        <div class="form-group {{ $errors->has('longitude') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="longitude" id="longitude" value="{{ old('longitude') }}" step="0.1">
