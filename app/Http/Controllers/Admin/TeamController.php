...
class TeamController extends Controller
{
    ...
    public function show(Team $team)
    {
        ...
        $team->load('team', 'teamUsers', 'teamContactCompanies', 'teamContactContacts', 'teamClubCarts', 'teamTreainers', 'teamTypeOfTrainers', 'teamServices', 'teamStocks', 'teamPermissions', 'teamRoles', 'teamTeams');
