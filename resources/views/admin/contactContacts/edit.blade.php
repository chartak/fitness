                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.contact-contacts.update", [$contactContact->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('branch_name') ? 'has-error' : '' }}">
                            <label for="branch_name">{{ trans('cruds.contactContact.fields.branch_name') }}</label>
                            <input class="form-control" type="text" name="branch_name" id="branch_name" value="{{ old('branch_name', $contactContact->branch_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('latitude') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="latitude" id="latitude" value="{{ old('latitude', $contactContact->latitude) }}" step="0.1">
                        ...
                        <div class="form-group {{ $errors->has('longitude') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="longitude" id="longitude" value="{{ old('longitude', $contactContact->longitude) }}" step="0.1">
...
@if(isset($contactContact) && $contactContact->logo)
      ...
      this.options.thumbnail.call(this, file, '{{ $contactContact->logo->getUrl('thumb') }}')
...
@if(isset($contactContact) && $contactContact->favicon)
      var file = {!! json_encode($contactContact->favicon) !!}
          this.options.addedfile.call(this, file)
      this.options.thumbnail.call(this, file, '{{ $contactContact->favicon->getUrl('thumb') }}')
      file.previewElement.classList.add('dz-complete')
