                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.stocks.update", [$stock->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('orderby') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="orderby" id="orderby" value="{{ old('orderby', $stock->orderby) }}" step="1" required>
...
@if(isset($stock) && $stock->photo)
      ...
      this.options.thumbnail.call(this, file, '{{ $stock->photo->getUrl('thumb') }}')
